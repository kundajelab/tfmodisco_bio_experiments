...
$TFNET_ROOT/scripts/prepare_data_pf.py --tfs REST --cells H1-hESC --no-bg True --stride 20
python $TFNET_ROOT/scripts/pick_summit.py --tfs REST --cells H1-hESC  | grep -v -P 'chr1\t' | bedtools sort > interpret.tsv
