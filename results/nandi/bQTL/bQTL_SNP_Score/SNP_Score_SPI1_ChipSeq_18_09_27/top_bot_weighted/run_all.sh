bedtools intersect -a $TFNET_ROOT/results/nandi/bQTL/analysis/bQTL_all_SNPs/SPI1.tsv -b /srv/scratch/ktian/kundajelab/tfmodisco_bio_experiments/results/nandi/bQTL/bQTL_Peaks/unzip/LCL-SPI1-human-EXP2-optimal_idr.narrowPeak > filter.bed
...
head -n 1854 filter.tsv > filter_top.tsv
tail -n 1854 filter.tsv > filter_bot.tsv
