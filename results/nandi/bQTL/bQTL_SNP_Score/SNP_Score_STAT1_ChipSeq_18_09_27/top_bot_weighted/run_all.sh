bedtools intersect -a $TFNET_ROOT/results/nandi/bQTL/analysis/bQTL_all_SNPs/STAT1.tsv -b /srv/scratch/ktian/kundajelab/tfmodisco_bio_experiments/results/nandi/bQTL/bQTL_Peaks/unzip/LCL-STAT1-human-EXP3-optimal_idr.narrowPeak > filter.bed
...
head -n 100 filter.tsv > filter_top.tsv
tail -n 100 filter.tsv > filter_bot.tsv
...
#ln -s STAT1_20k.tsv interpret.tsv
...
ln -s ../../../bQTL_ChipSeq_STAT1_18_08_29/model_files .
#ln -s /home/ktian/kundajelab/tfnet/results/nandi/STAT1/STAT1_GM12878_refine_18_09_04/model_files .
