...
$TFNET_ROOT/scripts/prepare_data_pf.py --tfs MAX --cells K562 --no-bg True --stride 20
python $TFNET_ROOT/scripts/pick_summit.py --tfs MAX --cells K562  | grep -v -P 'chr1\t' | bedtools sort > interpret.tsv
