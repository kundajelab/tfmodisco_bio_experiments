...
$TFNET_ROOT/scripts/prepare_data_pf.py --tfs CTCF --cells GM12878 --expr ENCSR000DZN --no-bg True --stride 20
python $TFNET_ROOT/scripts/pick_summit.py --tfs CTCF --cells GM12878 --expr ENCSR000DZN | grep -v -P 'chr1\t' | bedtools sort > interpret.tsv
