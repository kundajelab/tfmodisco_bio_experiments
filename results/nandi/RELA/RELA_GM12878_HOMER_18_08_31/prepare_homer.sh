...
$TFNET_ROOT/scripts/prepare_data_pf.py --tfs RELA --cells GM12878 --no-bg True --stride 20
python $TFNET_ROOT/scripts/pick_summit.py --tfs RELA --cells GM12878  | grep -v -P 'chr1\t' | bedtools sort > interpret.tsv
...
findMotifs.pl $homer_dir/pos.fa human $homer_dir/homer_out -fasta neg.fa -p 10 &> logs/homer.txt &
