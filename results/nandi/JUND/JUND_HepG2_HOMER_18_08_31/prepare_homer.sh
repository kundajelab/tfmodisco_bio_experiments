...
$TFNET_ROOT/scripts/prepare_data_pf.py --tfs JUND --cells HepG2 --no-bg True --stride 20
python $TFNET_ROOT/scripts/pick_summit.py --tfs JUND --cells HepG2  | grep -v -P 'chr1\t' | bedtools sort > interpret.tsv
...
cat headers.txt $dinuc > labels.tsv
