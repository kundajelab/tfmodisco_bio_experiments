...
$TFNET_ROOT/scripts/prepare_data_pf.py --tfs JUND --cells GM12878 --no-bg True --stride 20 --data-dir /home/ktian/kundajelab/tfnet/results/nandi/JUND/merged_peaks/

python $TFNET_ROOT/scripts/pick_summit.py --tfs JUND --cells GM12878 --data-dir /home/ktian/kundajelab/tfnet/results/nandi/JUND/merged_peaks/ | grep -v -P 'chr1\t' | bedtools sort > interpret.tsv
